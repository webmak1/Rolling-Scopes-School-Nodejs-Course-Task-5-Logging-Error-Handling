...
const task_memory_repository_1 = require("resources/tasks/task.memory.repository");
...
const getAll = async () => {
    ...
    return tasks.map(task_model_1.Task.toResponse);
};
/**
...
const get = async (req) => {
    ...
    return task_model_1.Task.toResponse(task);
};
/**
...
const create = async (req) => {
    ...
    const task = await task_memory_repository_1.tasksRepo.create(new task_model_1.Task({
        title,
        order,
        description,
        userId,
...
const update = async (req) => {
    ...
    return task_model_1.Task.toResponse(updatedTask);
};
/**
